...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
	...
	<div id="social">
		<a href="http://www.facebook.com/pages/Sun-Health-and-Nutrition/121514447945022"><img src="<?php echo base_path() . path_to_theme(); ?>/css/images/fb.png"></a>
  ...
  <div class="clr"></div>
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
	  ...
	  <div id="content" class="column"><div class="section">
		...
		<?php if($is_front) :?>
			<?php if ($hero): ?>
		      <div id="hero" class="hero-block"><div class="section">
		        <?php print $hero; ?>
		      </div></div> <!-- /.section, /#hero -->
		    <?php endif; ?>

			<?php if ($featured): ?>
		      <div id="featured" class="featured-block"><div class="section">
		        <?php print $featured; ?>
			...
			<?php if ($new_products): ?>
		      <div id="new_products" class="new-products-block"><div class="section">
		        <?php print $new_products; ?>
		      </div></div> <!-- /.section, /#new_products -->
		    <?php endif; ?>
